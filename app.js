...
function createBoard() {
    for (let i = 0; i < cardArray.length; i++) {
        ...
        card.setAttribute('src', 'images/Minecraft-logo.png')
...
function checkForMatch() {
    ...
    if(optionOneId == optionTwoId) {
        cards[optionOneId].setAttribute('src', 'images/Minecraft-logo.png')
        cards[optionTwoId].setAttribute('src', 'images/Minecraft-logo.png')
